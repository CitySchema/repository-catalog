...
<table class="dictionary">
    <tr>
        <td colspan="2"><b>Model Provenance Attributes:</b>Provide the information for identifying these models and understanding the provenance of models from the sources of the geometric observations and the creative effort of reducing these to a 3D model.</td>
    </tr>
    <tr>
...
<table class="dictionary">
    <tr>
        <td colspan="2"><b>Model Geometric Attributes:</b>These attributes are automatically generated by the model enrollment process.  These may be recalculated at times to synchronize with new parcels or re-configured tiles or the possibility that models have been moved or re-shaped.  
